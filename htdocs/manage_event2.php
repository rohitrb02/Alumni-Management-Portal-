...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO events (`title`,`content`,`schedule`,`banner`,`location`,`verified`,`varifiedby`,`posttimestamp`,`notice`) VALUES('".$title."','".$content."','".$schedule."','".$banner."','".$location."','".$verified."','".$varifiedby."',now(),'".$notice."')";
