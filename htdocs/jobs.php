        ...
        <div class="main-content">
                    ...
                    <div class="section-content text-center">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 text-center">
                                <h2 class="text-theme-colored font-36">Jobs </h2>
            ...
            <section class="divider parallax layer-overlay overlay-deep" data-stellar-background-ratio="0.2" data-bg-img="images/members/member-bg.jpg">
                <div class="container pb-80">
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <h3 class="text-uppercase mt-0">JOBS</h3>
                    ...
                    <section>
                            <button class="btn btn-primary btn-block col-sm-4" type="button" id="myButton"><i class="fa fa-plus"></i> Post Job</button>
                    ...
                    <div class="section-content">
                        <div class="row multi-row-clearfix">
                            ...
                            $sql_query = "SELECT * FROM `jobs` Where status='1' ORDER BY id DESC";
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="schedule-box maxwidth500 bg-light mb-30">
                                        <div class="thumb">
                                            ...
                                            <img height="300" width="300"class="img-fullwidth" alt="" src="uploads/<?php echo $row[3]; ?>">
                                            <div class="overlay">
                                        ...
                                        <div class="schedule-details clearfix p-15 pt-10" style="min-height: 316px;">
                                            ...
                                            <ul class="list-inline font-11 mb-20">
                                                ...
                                                <br>
                                                <li><i class="">Location</i> <a href="#"><?php echo $row[4]; ?></a></li>

                                                <br>
                                                <li><i class="">About</i> <a href="#"><?php echo $row[6]; ?></a></li>
                                                
                                                <br>
                                                <li><i class=""></i> <a href="#"><?php echo $row[5]; ?></a></li>
