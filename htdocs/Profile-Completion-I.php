...
// }
      ...
      $select="SELECT * from more_details where email='$email'";
      ...
      if(mysqli_num_rows($result) > 0){
       ...
       $register="INSERT INTO `more_details` ( `university`, `Degree`, `location`, `Primary_Email`, `Secondary_Email`, `website`, `linkedin`, `Twitter`, `Address`, `City`, `Postal`) VALUES ( '$university', '$Degree', '$location', '$Primary_Email', '$Secondary_Email', '$website', '$linkedin', '$Twitter', '$Address', '$City', '$Postal');";
