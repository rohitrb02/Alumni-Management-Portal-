        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              ...
              <p><h6 class="name"> Find your friends, batchmates and explore alumni of your interest!</h6> </p>             
               <p><h4 class="name"> <a href="#">Register / Login</a><span class="h6"> to browse members by Year, Name, Company, Profession, Industry or Location</span></h4> </p>
            </div>
          </div>
        </div>
          ...
          <div class="row multi-row-clearfix">
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/Dr-Pradeep-Hota.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Dr. Pradeep Hota</a></h4>
                  <h6 class="occupation">Researcher at Australian National University</h6>
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/Suresh-Dantam.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Suresh Dantam</a></h4>
                  <h6 class="occupation">Application Engineering Manager, Google</h6>
                  <p>B.Tech 2005, ELE</p>
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/Debabrata-Dash.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Debabrata Dash </a></h4>
                  <h6 class="occupation">Director Product Engineering at Motorola
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/Nishant-Das.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Nishant Das</a></h4>
                  <h6 class="occupation">Head- Talent Acquisition, Directi</h6>
                  <p>B.Tech 2004, CSE</p>
             ...
             <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/1.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">KANCHAN MAJEE</a></h4>
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/2.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Shyama Nayak</a></h4>
                  <h6 class="occupation">&nbsp;</h6>
                  <p>B.Tech 2015, ECE</p>
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/3.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Sidhartha Ratha </a></h4>
                  <h6 class="occupation">&nbsp;
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/members/4.jpg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">CHINMAYA SAHU</a></h4>
                  <h6 class="occupation">&nbsp;</h6>
                  <p>B.Tech 2019, ME</p>
    ...
    <div class="container pb-20">
      <div class="row multi-row-clearfix">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark"> NIST
            <p class="font-12 mt-10 mb-10">National Institute of Science and Technology (Autonomous)
        ...
        <div class="container pb-80">
          <div class="section-title text-center">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <p>
                <h4 class="name"> <a href="#">Register / Login</a><span class="h6"> to browse members by Year, Name, Company, Profession, Industry or Location</span></h4>
                </p>
              </div>
            </div>
          </div>
          <div class="section-content">
            <div class="row multi-row-clearfix">
              ...
              $sql_query = "SELECT * FROM `alumnus_bio` ORDER BY id DESC";
