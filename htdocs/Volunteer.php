        ...
        <div class="section-content text-center">
          <div class="row"> 
            <div class="col-md-6 col-md-offset-3 text-center">
              <h2 class="text-theme-colored font-36">Volunteer</h2>
    ...
    <section>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="col-md-10">
            <h3 class="line-bottom mt-0 mb-30">Kindly fill this form to express your interest. We’ll be contacting you soon.
            ...
            <form id="contact_form" name="contact_form" class="form-transparent" action="includes/sendmail.php" method="post">
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <label for="form_name">Interests <small>*</small></label>
                    <input id="form_subject" name="form_subject" class="form-control required" type="text" placeholder="Enter Your Interests">
                  </div>
                </div>
              ...
              <div class="col-sm-12">
              <div class="form-group">
                <label for="form_name">Expertise</label>
                <textarea id="form_message" name="form_message" class="form-control required" rows="5" placeholder="Enter Your Expertise"></textarea>
              </div>
              </div>
              <div class="col-sm-12">
                 <div class="form-group">
                <label for="form_name">Time you can contribute</label>
                <textarea id="form_message" name="form_message" class="form-control required" rows="5" placeholder="Enter Time you can contribute"></textarea>
              </div>
              </div><div class="col-sm-12">
                 <div class="form-group">
