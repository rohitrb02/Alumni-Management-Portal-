    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <footer class=" py-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                       <!-- <h3 class="mt-0 text-white">Contact us</h3>
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://nist.edu/" target="_blank">NIST Autonomous</a></div></div>
        </footer>
