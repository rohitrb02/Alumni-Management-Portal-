...
{
 $sql_query="UPDATE registration SET `status`='".$_GET['status']."' WHERE id=".$_GET['changestatus_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
?>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 TransitionalA//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
function edt_id(id)
{
  window.location.href='edit_registration.php?edit_id='+id;
}
function view_id(id)
{
  window.location.href='view_registration.php?view_id='+id;
}
...
<div id="body">
 <div id="content">
    ...
    <tr>
    <th colspan="5"><a href="add_registration.php">add registration.</a></th>
    </tr>
    <th>SL NO</th>
    <th>name</th>
