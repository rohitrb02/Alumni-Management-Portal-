...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=courses" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-list"></i></span> Branches</a>
				<a href="index.php?page=alumni" class="nav-item nav-alumni"><span class='icon-field'><i class="fa fa-users"></i></span> Alumni List</a>
				<a href="index.php?page=newsroom" class="nav-item nav-newsroom"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Newsroom</a>
				

				<a href="index.php?page=events" class="nav-item nav-events"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Events</a>
				<a href="index.php?page=webinar" class="nav-item nav-webinar"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Webinar</a>
				<a href="index.php?page=jobs" class="nav-item nav-jobs"><span class='icon-field'><i class="fa fa-briefcase"></i></span> Jobs</a>

				<a href="index.php?page=fund" class="nav-item nav-fund"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Fund Raising</a>
