...
<!-- 
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="id" value="<?php echo $_SESSION['bio']['id'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">10th Percentage/Cgpa</label>
                                                <input type="text" class="form-control" name="10th_Cgpa" value="<?php echo $_SESSION['bio']['10th_Cgpa'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                <label for="" class="control-label">12th Percentagee</label>
                                                <input type="text" class="form-control" name="lastname" value="<?php echo $_SESSION['bio']['lastname'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">School Name</label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Mobile Numbere</label>
                                                <input type="text" class="form-control" name="firstname" value="<?php echo $_SESSION['bio']['firstname'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Company Worked Withe</label>
                                                <input type="text" class="form-control" name="firstname" value="<?php echo $_SESSION['bio']['firstname'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
