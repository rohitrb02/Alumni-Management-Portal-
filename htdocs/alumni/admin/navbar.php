...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=news" class="nav-item nav-news"><span class='icon-field'><i class="fas fa-newspaper"></i></span> Post News</a>
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Users</a>
				<a href="index.php?page=more_details" class="nav-item nav-more_details"><span class='icon-field'><i class="fa fa-users"></i></span> More Details</a>
